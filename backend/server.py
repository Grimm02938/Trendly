...
async def get_categories():
    return {
        "categories": [
            ...
            {"id": "gaming", "name": "GAMING", "color": "bg-gradient-to-br from-slate-700 to-slate-600"},
            {"id": "sports-fitness", "name": "SPORTS & FITNESS", "color": "bg-gradient-to-br from-orange-500 to-amber-400"},
            {"id": "health-wellness", "name": "HEALTH & WELLNESS", "color": "bg-gradient-to-br from-red-500 to-pink-400"},
            {"id": "cooking", "name": "COOKING", "color": "bg-gradient-to-br from-yellow-500 to-amber-400"},
